...
@registry.register_transform(
    display_name="Retreive escort ad image links", 
    input_entity="maltego.PhoneNumber",
    description='Retrieves escort ad images from sumosearc.ch using phone number',
    settings=[],
    output_entities=["maltego.URL"],
    transform_set=sumoMaltego_set
    )
class phoneToImages(DiscoverableTransform):
    ...
    def create_entities(cls, request: MaltegoMsg, response: MaltegoTransform):
        ...
        async def main():
            ...
            results = wrestler.image_lookup(phone_number)
